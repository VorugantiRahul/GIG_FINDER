...
class AuthService {
  ...
  // Update password (used after user follows reset link and is signed in)
  static Future<void> updatePassword(BuildContext context, String password) async {
    try {
      await _authManager.updatePassword(password: password, context: context);
    } catch (e) {
  ...
  static Future<void> sendOtp(BuildContext context, String email) async {
    try {
      await _authManager.sendOtp(email: email, context: context);
    } catch (e) {
  ...
  // Verify OTP token
  static Future<bool> verifyOtp(BuildContext context, String email, String otp) async {
    try {
      return await _authManager.verifyOtp(email: email, otp: otp, context: context);
    } catch (e) {
