...
abstract class AuthManager {
  ...
  Future sendOtp({required String email, required BuildContext context});
  Future<bool> verifyOtp({required String email, required String otp, required BuildContext context});
  Future updatePassword({required String password, required BuildContext context});
...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  @override
  Future sendOtp({required String email, required BuildContext context}) async {
    try {
  ...
  Future<bool> verifyOtp({required String email, required String otp, required BuildContext context}) async {
    try {
      await SupabaseConfig.auth.verifyOTP(email: email, token: otp, type: sb.OtpType.email);
      return true;
    } on sb.AuthException catch (e) {
      throw Exception(e.message);
    } catch (e) {
  ...
  @override
  Future updatePassword({required String password, required BuildContext context}) async {
    try {
      await SupabaseConfig.auth.updateUser(sb.UserAttributes(password: password));
    } on sb.AuthException catch (e) {
      throw Exception(e.message);
    } catch (e) {
